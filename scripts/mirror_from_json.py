...
def process_one(origin_url: str, explicit_out_basename: str | None = None):
    xml_bytes = fetch(origin_url)
    ...
    base = explicit_out_basename or last_path_segment(ch_link) or "feed"
    out_name = f"{base}.xml"
